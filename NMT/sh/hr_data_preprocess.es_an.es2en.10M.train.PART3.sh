...
DATA=/home/hatch5o6/nobackup/archive/data/LRRomance/es-en/CCMatrix/fixed/cleaned/tgt.10M.txt
...
FINAL_RESULTS=/home/hatch5o6/nobackup/archive/data/LRRomance/es-en/CCMatrix/fixed/cleaned/tgt.10M.SC_es2an.txt
...
# sleep 5000 # should be done predicting by the time this up
