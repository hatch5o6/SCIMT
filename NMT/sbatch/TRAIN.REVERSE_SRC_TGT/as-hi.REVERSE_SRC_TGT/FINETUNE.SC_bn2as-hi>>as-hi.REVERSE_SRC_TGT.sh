...
#SBATCH --job-name=TRAIN.as-hi.FINETUNE.SC_bn2as-hi>>as-hi.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/as-hi/FINETUNE.SC_bn2as-hi>>as-hi.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
