...
#SBATCH --job-name=TRAIN.hsb-de.PRETRAIN.SC_cs2hsb-de.TEST-hsb-de
#SBATCH --qos=dw87
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/hsb-de/PRETRAIN.SC_cs2hsb-de.TEST-hsb-de.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
