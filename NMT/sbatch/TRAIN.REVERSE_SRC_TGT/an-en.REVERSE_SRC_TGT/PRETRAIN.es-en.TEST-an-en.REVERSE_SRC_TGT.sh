...
#SBATCH --job-name=TRAIN.an-en.PRETRAIN.es-en.TEST-an-en.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/an-en/PRETRAIN.es-en.TEST-an-en.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
