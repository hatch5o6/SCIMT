...
#SBATCH --job-name=TRAIN.fon-fr.FINETUNE.SC_ewe2fon-fr>>fon-fr.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/fon-fr/FINETUNE.SC_ewe2fon-fr>>fon-fr.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
