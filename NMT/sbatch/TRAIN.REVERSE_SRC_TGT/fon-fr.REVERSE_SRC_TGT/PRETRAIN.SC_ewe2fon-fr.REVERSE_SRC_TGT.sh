...
#SBATCH --job-name=TRAIN.fon-fr.PRETRAIN.SC_ewe2fon-fr.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/fon-fr/PRETRAIN.SC_ewe2fon-fr.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
