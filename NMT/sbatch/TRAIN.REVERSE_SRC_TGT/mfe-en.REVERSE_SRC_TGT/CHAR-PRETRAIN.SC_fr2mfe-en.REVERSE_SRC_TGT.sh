...
#SBATCH --job-name=TRAIN.mfe-en.CHAR-PRETRAIN.SC_fr2mfe-en.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/mfe-en/CHAR-PRETRAIN.SC_fr2mfe-en.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
