...
#SBATCH --job-name=TRAIN.mfe-en.PRETRAIN.SC_fr2mfe-en.no_grad_clip.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/mfe-en/PRETRAIN.SC_fr2mfe-en.no_grad_clip.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
