...
#SBATCH --job-name=TRAIN.ewe-en.FINETUNE.SC_fon2ewe-en>>ewe-en.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/ewe-en/FINETUNE.SC_fon2ewe-en>>ewe-en.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
