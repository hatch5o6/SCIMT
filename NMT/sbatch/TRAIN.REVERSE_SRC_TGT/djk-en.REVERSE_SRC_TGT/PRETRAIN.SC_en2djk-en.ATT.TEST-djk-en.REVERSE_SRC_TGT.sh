...
#SBATCH --job-name=TRAIN.djk-en.PRETRAIN.SC_en2djk-en.ATT.TEST-djk-en.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/djk-en/PRETRAIN.SC_en2djk-en.ATT.TEST-djk-en.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
