...
#SBATCH --job-name=TRAIN.djk-en.FINETUNE.SC_en2djk-en>>djk-en.ATT.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/djk-en/FINETUNE.SC_en2djk-en>>djk-en.ATT.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
