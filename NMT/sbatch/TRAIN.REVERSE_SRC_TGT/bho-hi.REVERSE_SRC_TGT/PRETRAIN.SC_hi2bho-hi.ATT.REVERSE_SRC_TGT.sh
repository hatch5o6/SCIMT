...
#SBATCH --job-name=TRAIN.bho-hi.PRETRAIN.SC_hi2bho-hi.ATT.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/bho-hi/PRETRAIN.SC_hi2bho-hi.ATT.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
