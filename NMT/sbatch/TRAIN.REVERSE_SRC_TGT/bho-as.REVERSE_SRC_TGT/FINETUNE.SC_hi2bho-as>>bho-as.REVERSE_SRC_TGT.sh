...
#SBATCH --job-name=TRAIN.bho-as.FINETUNE.SC_hi2bho-as>>bho-as.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/bho-as/FINETUNE.SC_hi2bho-as>>bho-as.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
