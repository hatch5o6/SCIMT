...
#SBATCH --job-name=TRAIN.bho-as.FINETUNE.hi-as>>bho-as.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/bho-as/FINETUNE.hi-as>>bho-as.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
