...
#SBATCH --job-name=TRAIN.an-en_chosen_2.AUGMENT.SC_es2an-en.REVERSE_SRC_TGT
#SBATCH --qos=matrix
...
srun python NMT/train.py \
	--config "/home/hatch5o6/Cognate/code/NMT/configs/CONFIGS/an-en_chosen_2/AUGMENT.SC_es2an-en.yaml" \
	--mode TRAIN \
	--REVERSE_SRC_TGT
