...
#SBATCH --job-name=hyper_param_search.fr-mfe.13.cfg.PREDICTION
#SBATCH --qos cs
#SBATCH --partition cs

nvidia-smi

bash Pipeline/pred_SC.sh /home/hatch5o6/Cognate/code/Pipeline/cfg/SC-HYPERPARAM_SEARCH/fr-mfe.13.cfg
