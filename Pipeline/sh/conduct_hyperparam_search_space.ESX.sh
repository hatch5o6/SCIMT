...
rm /home/hatch5o6/Cognate/code/Pipeline/sbatch/hyper_param_search_oc_abl/esx-anx*

echo "Removing cfgs"
rm /home/hatch5o6/Cognate/code/Pipeline/cfg/SC-HYPERPARAM_SEARCH_OC_ABL/esx-anx*

echo "Removing slurm outputs"
rm /home/hatch5o6/Cognate/code/Pipeline/slurm_outputs/hyper_param_search_outputs_oc_abl/*esx-anx*

echo "Removing smt slurm outputs"
rm /home/hatch5o6/Cognate/code/Pipeline/slurm_outputs/SC_smt/*esx-anx*
rm /home/hatch5o6/Cognate/code/Pipeline/slurm_outputs/SC_smt_oc_abl/*esx-anx*
...
# echo "DELETED FOLDERS AND FILES BUT DID NOT MAKE SEARCH SPACE"
# exit
...
python Pipeline/make_hyperparam_search_space.py \
    ...
    --cfgs /home/hatch5o6/Cognate/code/Pipeline/cfg/SC_ablations/esx-anx.cfg \
    --tag oc_abl
...
echo "RNN SBATCH:-"
for f in /home/hatch5o6/Cognate/code/Pipeline/sbatch/hyper_param_search_oc_abl/esx-anx*
do
    echo "    $f"
    sbatch $f
done
...
echo ""
echo "SMT SBATCH:-"
for f in /home/hatch5o6/Cognate/code/Pipeline/sbatch/smt_oc_abl/esx-anx*
do
    echo "    $f"
    sbatch $f
done