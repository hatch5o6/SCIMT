...
rm /home/hatch5o6/Cognate/code/Pipeline/sbatch/hyper_param_search_oc_abl/frx-mfx*

echo "Removing cfgs"
rm /home/hatch5o6/Cognate/code/Pipeline/cfg/SC-HYPERPARAM_SEARCH_OC_ABL/frx-mfx*

echo "Removing slurm outputs"
rm /home/hatch5o6/Cognate/code/Pipeline/slurm_outputs/hyper_param_search_outputs_oc_abl/*frx-mfx*

echo "Removing smt slurm outputs"
rm /home/hatch5o6/Cognate/code/Pipeline/slurm_outputs/SC_smt_oc_abl/*frx-mfx*
...
python Pipeline/make_hyperparam_search_space.py \
    ...
    --cfgs /home/hatch5o6/Cognate/code/Pipeline/cfg/SC_ablations/frx-mfx.cfg \
    --tag oc_abl
...
echo "RNN SBATCH:-"
for f in /home/hatch5o6/Cognate/code/Pipeline/sbatch/hyper_param_search_oc_abl/frx-mfx*
do
    echo "    $f"
    sbatch $f
done
...
echo ""
echo "SMT SBATCH:-"
for f in /home/hatch5o6/Cognate/code/Pipeline/sbatch/smt_oc_abl/frx-mfx*
do
    echo "    $f"
    sbatch $f
done